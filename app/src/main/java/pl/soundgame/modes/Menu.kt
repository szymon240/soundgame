...
class Menu(var context: Context, private val changeModeCallback: (GameModeName) -> Unit) : GameMode() {
    override fun returnGameModeScene(): Scene {
        ...
        val rhythmModeButton = Button(loadTextureBitmap("button.png", context), id = "rhythmModeButton")
        ...
        val instrumentalModeButton = Button(loadTextureBitmap("button.png", context), id = "instrumentalModeButton")
        instrumentalModeButton.setOriginPosition(y = -0.3f, x = 0f)  // Position button below the Rhythm button
